...
Loggly.prototype.log = function (inputId, msg, callback) {
  ...
  // Doing instanceof here doesn't work with the Haraka email server because it
  // loads plugins (including logging) into a sandbox but uses require from the
  // main environment inside the sandbox. Morale of the story - objects ain't
  // objects across those boundaries. Typeof may be less awesome, but it works.
